 ...
 * }
 */
export async function mandatorySafeParseAsync<T extends z4.ZodTypeAny>(schema: T, input: unknown) {
 ...
 * )
 */
export function createMandatoryRecord<V extends z4.ZodTypeAny>(
  valueSchema: V,
  description: string
) {
