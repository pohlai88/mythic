...
export const buttons = {
  primary: 'px-6 py-2 bg-gold text-void rounded-xs font-mono text-sm hover:bg-ember transition-all duration-1618 disabled:opacity-50',
  secondary: 'px-4 py-2 bg-obsidian text-parchment border border-charcoal rounded-xs font-mono text-sm hover:border-gold transition-all duration-1618 disabled:opacity-50',
 ...
 */
export const inputs = {
  default: 'flex-1 bg-obsidian border border-charcoal rounded-xs px-4 py-2 text-parchment placeholder-ash focus:outline-hidden focus:border-gold transition-all duration-1200',
  textarea: 'flex-1 bg-obsidian border border-charcoal rounded-xs px-4 py-2 text-parchment placeholder-ash focus:outline-hidden focus:border-gold transition-all duration-1200 resize-y',
} as const
