 ...
 */
export const createProposalInputSchema = z4.object({
 ...
 */
export const approveProposalInputSchema = z4.object({
 ...
 */
export const vetoProposalInputSchema = z4.object({
 ...
 */
export const getProposalInputSchema = z4.object({
