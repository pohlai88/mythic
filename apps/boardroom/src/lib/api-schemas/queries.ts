 ...
 */
export const proposalQuerySchema = z4
  .object({
    // Filter parameters
    ...
    // Sorting parameters
    sort: z4
      .enum(["created_at", "updated_at", "case_number", "status"])
      .default("created_at")
    ...
    search: z4
      ...
      .catch("")
      .optional()
      .describe("Search query (searches case number and data)"),

    // Date range filters
    createdAfter: z4.coerce.date().optional().describe("Filter proposals created after this date"),
    createdBefore: z4.coerce
      .date()
      .optional()
      .describe("Filter proposals created before this date"),
