 ...
 */
export const encryptionKeySchema = z4
  .object({
 ...
 */
export const encryptedDataSchema = z4
  .object({
 ...
 */
export const decryptionRequestSchema = z4
  .object({
 ...
 */
export const vaultKeyStorageSchema = z4
  .object({
    keyId: z4.string().uuid(),
 ...
 */
export const encryptionRequestSchema = z4
  .object({
