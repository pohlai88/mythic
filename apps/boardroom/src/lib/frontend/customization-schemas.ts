 ...
 */
export const layoutConfigSchema = z4.object({
 ...
 */
export const viewConfigSchema = z4.object({
 ...
 */
export const componentConfigSchema = z4.object({
 ...
 */
export const frontendCustomizationSchema = z4.object({
