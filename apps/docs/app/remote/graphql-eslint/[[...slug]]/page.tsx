...
import config from '../../../../nextra-remote-filepaths/graphql-eslint.json'
...
const eslintPageMap = _pageMap[0]
  ? mergeMetaWithPageMap(_pageMap[0], {})
  : { name: 'graphql-eslint', route: '/remote/graphql-eslint', children: [] }
...
export async function generateMetadata(props: {
  ...
  try {
    ...
    return {
      title: metadata?.title || 'GraphQL ESLint Documentation',
      description:
        metadata?.description ||
        'Comprehensive documentation for GraphQL ESLint - Lint your GraphQL operations',
      keywords: [
        'GraphQL',
        'ESLint',
        'Linting',
      ...
      openGraph: {
        title: metadata?.title || 'GraphQL ESLint Documentation',
        description: metadata?.description || 'Comprehensive documentation for GraphQL ESLint',
        type: 'article',
        url: `https://nexuscanon.dev/remote/graphql-eslint/${route}`,
      },
      twitter: {
    ...
    return {
      title: 'GraphQL ESLint Documentation',
      description: 'Documentation for GraphQL ESLint',
    }
  }
}
