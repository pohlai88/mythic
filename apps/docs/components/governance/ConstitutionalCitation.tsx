...
export function ConstitutionalCitation({
  ...
  const content = (
    <span className="inline-flex items-center gap-1.5 rounded-xs border border-amber-200 bg-amber-50 px-2 py-1 text-sm dark:border-amber-800 dark:bg-amber-900/50">
