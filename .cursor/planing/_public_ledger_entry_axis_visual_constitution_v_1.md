...
> If the AXIS Visual Constitution text changes by even 1 character, this hash
> must be recomputed.
...
> - Compute `entry_hash` LAST, after canonicalizing the JSON envelope (per
...
```json
{
  ...
  "scope_declaration": ["AXIS Visual Constitution v1.0"],
  "payload": {
    "supersedes": null,
...
**Impact:** AXIS surfaces must declare Design Mode + versions; default is **The
Apex v2.1**.  
**Enforcement:** Titan gate `TITAN-CI-AXIS01` becomes active for design
