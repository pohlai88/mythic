...
**Generated**: 2026-01-10 **Status**: ACTIVE **Purpose**: Comprehensive
documentation registry to prevent duplicates and enforce DRY principles
...
**Note**: Public governance docs in `content/governance/` are separate
(public-facing)
...
- ⚠️ SYS-007 and SYS-008: Strategy vs Quick Start - **REVIEW** (may be
  intentional)
- ⚠️ SYS-009 and SYS-010: Strategy vs Summary - **CONSOLIDATE** (summary
  redundant)
...
- ⚠️ Multiple legacy versions in `.cursor/planing/` - **ARCHIVE** (see
  MIGRATION_PLAN.md)
...
- `docs/_system/DOC-0103_documentation-organization-quick-start.md` (Quick
  Start)
...
**Status**: Active Registry **Last Updated**: 2026-01-10 **Next Review**:
2026-01-17 (weekly)
