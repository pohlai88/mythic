...
**Purpose**: Record all architectural and organizational decisions
**Format**: Append-only (never edit/delete previous decisions)
**Authority**: System Architect + Stakeholder Approval
...
- Essential files defined as:
  ...
  - Documentation strategy (DOCUMENTATION_ORGANIZATION_*.md)
  - Critical config/reference (NEXTJS_*, EXTERNAL_*, TEST_*)
...
**Impacts**:
- Files with "Legacy_" prefix would move to `.cursor/archive/legacy/`
