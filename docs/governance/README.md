...
### Active Governance
**Location**: `active/`
**Purpose**: Working governance documents (mutable, versioned)
...
### Draft Governance
**Location**: `draft/`
**Purpose**: Proposed governance documents (pre-ratification)
...
**Draft**: Pre-ratification, working documents
**Active**: Ratified, current operational documents
**Sealed**: Immutable, foundational documents (hash-verified, ledger-tracked)
**Legacy**: Superseded, archived for historical reference
...
- **[Contradictions](../_system/CONTRADICTIONS.md)** - Conflict tracking & resolution
...
- **Architecture Decisions**: [`../architecture/`](../architecture/) - Technical ADRs

---

**For Public Governance**: Visit [content/governance/](../../content/governance/)
