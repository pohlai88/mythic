...
The warnings you see are from **subdependencies** (dependencies of
dependencies):
...
Your Node.js version management is configured. You can continue development with
Node.js v22.20.0, or switch to 20.18.0 for LTS stability.
