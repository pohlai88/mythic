...
created: 2026-01-11
modified: 2026-01-11
tags: [tailwind, diataxis, documentation, navigation]
related_docs:
...
- [Setting Up Design Tokens from Figma](./tutorials/03-figma-tokens-setup.md)

**When to use**: You want to learn how to accomplish a task from scratch.

---

### 🔧 How-To Guides (Problem-Oriented)

**Purpose**: Guide you through the steps required to solve a particular problem.
...
- [How to Create Custom Utilities](./how-to/03-create-custom-utilities.md)
- [How to Migrate from Tailwind v3 to v4](./how-to/04-migrate-v3-to-v4.md)
...
- [CSS Utilities Reference](./reference/css-utilities.md)
...
- [Understanding Intelligence-Driven Styling](./explanation/03-intelligence-styling.md)
- [Understanding Figma Integration](./explanation/04-figma-integration.md)
- [Understanding Performance Optimization](./explanation/05-performance-optimization.md)
...
1. **Tutorials** use first-person plural ("we") and take you step-by-step
2. **How-to guides** are goal-oriented and problem-focused
3. **Reference** is accurate, complete, and technical
4. **Explanation** provides context and understanding
...
- [System Architecture](../architecture/DOC-0100_system-architecture.md)
- [Design System Architecture](../architecture/DESIGN_SYSTEM.md)
- [Handoff Integration Guide](../guides/HANDOFF_INTEGRATION.md)
- [Figma MCP Integration](../guides/FIGMA_MCP_INTEGRATION.md)
