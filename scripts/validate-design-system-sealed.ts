...
const DESIGN_SYSTEM_PATH = 'packages/design-system'
const ALLOWED_FILES = [
...
function main() {
  ...
  if (!success) {
    ...
    console.error('')
    console.error('The packages/design-system package has been validated as ELITE-compliant')
    ...
    console.error('  - Validation Report: packages/design-system/VALIDATION_REPORT.md')
